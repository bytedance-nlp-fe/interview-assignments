export const RightArrowIcon = (
  <svg width="1rem" height="1rem" viewBox="0 0 48 48" fill="none">
    <path
      d="M16 39.513l15.556-15.557L16 8.4"
      stroke="currentColor"
      strokeWidth="2"
    />
  </svg>
...
export const CheckIcon = (
  <svg width="1rem" height="1rem" viewBox="0 0 48 48" fill="none">
    <path
      d="M41.678 11.05L19.05 33.678 6.322 20.95"
      stroke="currentColor"
      strokeWidth="2"
    />
  </svg>
